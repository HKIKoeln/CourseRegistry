...
<ul>
	...
	<li>
		Credits to: 
		<?php echo $this->Html->link('Erasmus University Rotterdam', 'http://www.eur.nl/', array('target' => '_blank')); ?>, 
		<?php echo $this->Html->link('University of Cologne', 'http://www.uni-koeln.de/', array('target' => '_blank')); ?>
