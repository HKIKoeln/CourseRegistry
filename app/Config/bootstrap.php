...
/** 
* This constant is only used by the crontasks,
...
// cake internal base url - will be prepended to Router::url(/foo/bar, $full = true) => https://dariah.uni-koeln.de/foo/bar
Configure::write('App.fullBaseUrl', 'https://dariah.uni-koeln.de');
