 ...
 *
 */
	// this handles view caching - not in use
 ...
 * Please enter 40 random alphanumeric charcters under [ToDo]
 */
	Configure::write('Security.salt', '[ToDo]');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '[ToDo]');
